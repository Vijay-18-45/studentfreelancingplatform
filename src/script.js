        ...
        <div class="max-w-4xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
            <div class="md:w-1/2 p-12 flex flex-col justify-center">
                ...
                <h2 class="text-4xl font-extrabold text-gray-900 mb-6 leading-tight">
                    The Smart Way to <span class="text-indigo-600">Earn & Learn</span> on Campus.
                </h2>
                <p class="text-gray-600 mb-8 text-lg">
                    Connect with fellow students for tutoring, coding, design, and more. Build your portfolio while you study.
                </p>
                <div class="space-y-4">
                    ${Button('Login as Student (Worker)', () => handleLogin('student_worker'), 'primary', 'w-full py-4 text-lg')}
                    ${Button('Login as Student (Buyer)', () => handleLogin('student_buyer'), 'outline', 'w-full py-4 text-lg')}
                    ${Button('Admin Access', () => handleLogin('admin'), 'ghost', 'w-full text-sm')}
                </div>
            </div>
            <div class="md:w-1/2 bg-indigo-50 p-12 flex items-center justify-center relative overflow-hidden">
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden relative z-10 p-6 w-full max-w-xs transform rotate-2 hover:rotate-0 transition-transform duration-500">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center">
                            ${Icon('check-circle', 'text-green-600 w-6 h-6')}
                        </div>
                        <div>
                            <p class="text-xs text-gray-500 font-medium uppercase tracking-wider">Task Completed</p>
                            <p class="font-bold text-gray-900">Python Scripting</p>
                        </div>
                    </div>
                    <div class="flex justify-between items-center">
                        <p class="text-indigo-600 font-bold">₹450 Earned</p>
                        <div class="flex gap-1">
                            ${[1, 2, 3, 4, 5].map(() => Icon('star', 'w-3 h-3 fill-yellow-400 text-yellow-400')).join('')}
                        </div>
                    </div>
                </div>
            </div>
    ...
    return `
        <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden p-6 border-l-4 border-indigo-600">
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden p-6 border-l-4 border-green-500">
                    <div class="flex justify-between items-start mb-4">
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden p-6 border-l-4 border-yellow-500">
                    <div class="flex justify-between items-start mb-4">
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden p-6 border-l-4 border-purple-500">
                    <div class="flex justify-between items-start mb-4">
        ...
        <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ${filteredTasks.map(task => {
                    ...
                    return `
                        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden flex flex-col h-full hover:shadow-lg transition-all border-t-4 border-indigo-600">
...
const NotificationsView = () => {
    ...
    return `
        <div class="max-w-2xl mx-auto space-y-8">
            ...
            <div class="space-y-4">
                ${userNotifs.length > 0 ? userNotifs.map(notif => `
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden p-5 flex gap-4 items-start ${!notif.read ? 'border-l-4 border-indigo-600 bg-indigo-50/30' : ''}">
